...
int read_all_block(char* data){
    ...
    //Scorro tutti i blocchi validi memorizzati in una lista doppiamente collegata. L'offset del primo blocco valido da leggere è salvato in "meta_block_rcu->firstBlock"
